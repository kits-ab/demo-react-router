...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Welcome = __webpack_require__(210);
	...
	var _Logout = __webpack_require__(219);
	...
	var _Links = __webpack_require__(223);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: 'links', component: _App2.default, onEnter: requireAuth },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: _Index2.default }),
			_react2.default.createElement(
				_reactRouter.Route,
				{ path: ':listId', component: Links.List },
				_react2.default.createElement(_reactRouter.IndexRoute, { component: Links.Index }),
				_react2.default.createElement(
					_reactRouter.Route,
					{ path: ':linkId', component: Links.Show },
					_react2.default.createElement(_reactRouter.Route, { path: 'info', component: Links.Info })
				)
			),
...
/***/ function(module, exports) {
	...
	module.exports = {
		login: function login(user, password, callback) {
			...
			pretendRequest(user, password, function (result) {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'p',
					{ className: 'c-intro' },
					'This demo shows how React Router can be used to let the url drive the state of a web application. This will let users bookmark, reload and navigate the application using the built-in controls of the browser.'
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'c-entrypoint__wrapper' },
						_react2.default.createElement(
							'div',
							{ className: 'c-entrypoint__column' },
							_react2.default.createElement(
								'h2',
								null,
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/kits-ab/demo-react-router' },
									'GitHub'
								),
								' and all of the steps necessary to create it is explained in detail on my company\'s blog.'
							),
							_react2.default.createElement(
								'p',
								{ className: 'c-entrypoint__button' },
								_react2.default.createElement(
									'a',
									{ className: 'c-button', href: 'http://kits.se/blogg/react-router' },
									'Read the blog post'
								)
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								null,
								'You are already running the demo since this page is part of it but to run the real application log in with the username \'',
								_react2.default.createElement(
									'b',
									null,
									'user'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
		...
		handleSubmit: function handleSubmit(event) {
			...
			_auth2.default.login(user, pass, function (loggedIn) {
				if (!loggedIn) {
				...
				if (location.state && location.state.nextPathname) {
					...
					_this.history.replaceState(null, '/links/public');
				}
			});
		},
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'form',
					{ className: 'c-login__form', onSubmit: this.handleSubmit },
					_react2.default.createElement(
						'label',
						{ className: 'c-login__label', htmlFor: 'user' },
						'Username'
					),
					_react2.default.createElement('input', { id: 'user', className: 'c-login__input', ref: 'user', type: 'text', placeholder: 'user' }),
					_react2.default.createElement(
						'label',
						{ className: 'c-login__label', htmlFor: 'pass' },
						'Password'
					),
					_react2.default.createElement('input', { id: 'pass', className: 'c-login__input', ref: 'pass', type: 'text', placeholder: 'password' }),
					...
					_react2.default.createElement(
						'button',
						{ className: 'c-login__button', type: 'submit' },
						_react2.default.createElement('img', { alt: 'Login', src: '/images/login.svg' })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data = __webpack_require__(221);
	...
	exports.default = _react2.default.createClass({
		displayName: 'App',
		render: function render() {
			var counts = _data2.default.getCountForLists();
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/links/all' },
								_react2.default.createElement('img', { src: '/images/all.svg' }),
								'All',
								_react2.default.createElement(
									'span',
									{ className: 'c-lists__count' },
									counts.all
								)
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/links/private' },
								_react2.default.createElement('img', { src: '/images/private.svg' }),
								'Private',
								_react2.default.createElement(
									'span',
									{ className: 'c-lists__count' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/links/public' },
								_react2.default.createElement('img', { src: '/images/public.svg' }),
								'Public',
								_react2.default.createElement(
									'span',
									{ className: 'c-lists__count' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/links/unread' },
								_react2.default.createElement('img', { src: '/images/unread.svg' }),
								'Unread',
								_react2.default.createElement(
									'span',
									{ className: 'c-lists__count' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/links/untagged' },
								_react2.default.createElement('img', { src: '/images/tag.svg' }),
								'Untagged',
								_react2.default.createElement(
									'span',
									{ className: 'c-lists__count' },
					...
					_react2.default.createElement('hr', { className: 'c-lists__separator' }),
					_react2.default.createElement(
						'ul',
						{ className: 'c-lists' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/settings' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-lists__item', to: '/logout' },
								_react2.default.createElement('img', { src: '/images/logout.svg' }),
								'Log out'
							)
						)
					)
...
/***/ function(module, exports) {
	...
	module.exports = {
		getCountForLists: function getCountForLists() {
			return {
		...
		getLinksForList: function getLinksForList(list) {
			if (list === 'all') {
				return links;
				...
				return links.filter(function (link) {
					return link.shared === 'yes';
				});
			} else if (list === 'unread') {
				return links.filter(function (link) {
					return link.toread === 'yes';
				});
			} else if (list === 'untagged') {
				return links.filter(function (link) {
					return !link.tags || link.tags.length === 0;
				});
			} else {
				return [];
			}
		},
		getLinkById: function getLinkById(id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "c-app__content c-column" },
				_react2.default.createElement(
					"div",
					{ className: "c-column__header" },
					_react2.default.createElement(
						"h2",
						null,
						"Links"
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Index = exports.Info = exports.Show = exports.List = undefined;
	...
	var List = exports.List = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'c-app__content c-content' },
				_react2.default.createElement(
					'div',
					{ className: 'c-content__navigation c-column' },
					_react2.default.createElement(
						'div',
						{ className: 'c-column__header' },
						_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'c-column__content no-padding' },
						_data2.default.getLinksForList(listId).map(function (link, index) {
							return _react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-link',
								...
								_react2.default.createElement(
									'p',
									null,
									link.tags.split(' ').map(function (tag, index) {
										return _react2.default.createElement(
											'span',
											{ className: 'c-tag' },
											tag
	...
	var Show = exports.Show = _react2.default.createClass({
		displayName: 'Show',
		render: function render() {
			var _props$params = this.props.params;
			var listId = _props$params.listId;
			var linkId = _props$params.linkId;

			var link = _data2.default.getLinkById(linkId);

			return _react2.default.createElement(
				'div',
				{ className: 'c-content__content c-column' },
				_react2.default.createElement(
					'div',
					{ className: 'c-column__header c-navbar' },
					_react2.default.createElement(
						'h2',
						{ className: 'c-navbar__header' },
						link.description
					),
					_react2.default.createElement(
						'ul',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ activeClassName: 'is-active', className: 'c-navbar__menu-item',
									to: '/links/' + listId + '/' + linkId + '/info' },
								_react2.default.createElement('img', { alt: 'Info', src: '/images/info.svg' })
							)
						)
					)
				),
				_react2.default.createElement('iframe', { className: 'c-column__content no-padding',
					sandbox: 'allow-same-origin allow-scripts', src: link.href }),
				_react2.default.createElement(
					_reactAddonsCssTransitionGroup2.default,
					{ transitionName: 'fade',
	...
	var Info = exports.Info = _react2.default.createClass({
		displayName: 'Info',
		render: function render() {
			var _props$params2 = this.props.params;
			var listId = _props$params2.listId;
			var linkId = _props$params2.linkId;
	...
	var Index = exports.Index = _react2.default.createClass({
		displayName: 'Index',
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'c-app__content c-column' },
				_react2.default.createElement('div', { className: 'c-column__header' }),
				_react2.default.createElement(
					'div',
					{ className: 'c-column__content' },
					_react2.default.createElement(
